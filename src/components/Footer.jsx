          ...
          <div className="mb-3 flex flex-wrap justify-between md:flex-nowrap">
            <div className="flex w-24 justify-between">
              <a
                ...
                target="blank"
                className="social-link flex items-center gap-2 rounded-full bg-primaryBgLight p-1 hover:bg-activeLight"
              >
                <svg
                  height="20"
                  width="20"
                  viewBox="0 0 16 16"
                  className="rounded-full bg-primaryBgLight fill-primaryBgDark hover:bg-activeLight"
                >
        ...
        <div className="mt-5 block lg:flex">
            ...
            <div className="lg:h-16 lg:min-h-[300px]">
              ...
              <div>
                <p className="mt-2 w-full text-xs text-secondaryBgDark dark:text-secondaryBgLight lg:w-[300px]">
                  ...
                  platform powered by Alchemy & Ethers SDK, enabling developers
                  to explore, verify and analyze blockchain data.
                </p>
              </div>
          ...
          <section className="mx-0 my-5 flex w-full flex-row lg:ml-20 lg:mt-0">
            <div className="w-full px-0 sm:w-1/3 lg:px-3">
              ...
              <ul>
                {Object.keys(Company).map((title) => (
                  <li className="my-4 text-xs" key={title}>
                    <a href={Company[title]}>{title}</a>
                  </li>
                ))}
              </ul>
            </div>
            <div className="w-full px-0 sm:w-1/3 lg:px-3">
              ...
              <ul>
                {Object.keys(Community).map((title) => (
                  <li className="my-4 text-xs" key={title}>
            ...
            <div className="w-full px-0 sm:w-1/3 lg:px-3">
              ...
              <ul>
                {Object.keys(ProductsAndServices).map((title) => (
                  <li className="my-4 text-xs" key={title}>
                    <a href={ProductsAndServices[title]}>{title}</a>
                  </li>
                ))}
              </ul>
            </div>
