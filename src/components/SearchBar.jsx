...
const SearchBar = () => {
  ...
  return (
    <section className="m-auto hidden w-full flex-col px-5 py-2 md:flex">
      <form className="relative hidden sm:flex" onSubmit={submit}>
        <input
          type="search"
          name="search"
          id="search"
